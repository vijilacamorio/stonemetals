...
<div class="page-content">
           <!-- SLIDER START --> 
                ...
                <div id="welcome_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="goodnews-header" data-source="gallery" style="background:#eeeeee;padding:0px;">
                    <div id="welcome" class="rev_slider fullscreenbanner"  data-version="5.4.3.1">
                        ...
                        <!-- SLIDE 1 -->
                            ...
                            data-thumb="images/main-slider/slider5/slide1.jpg"  
                            data-rotate="0"  
                            ...
                            data-description="">
                                ...
                                <div class="tp-caption   tp-resizeme site-text-white" 
                                id="slide-901-layer-2" 
                                data-x="['left','left','left','left']" data-hoffset="['0','0','0','10']" 
                                data-y="['top','top','top','top']" data-voffset="['160','160','160','180']"  
                                data-fontsize="['38','38','38','22']"
                                ...
                                data-y="['top','top','top','top']" data-voffset="['240','250','250','230']"  
                                data-fontsize="['120','72','72','38']"
                                data-lineheight="['100','66','68','38']"
                                data-width="['700','700','96%','96%']"
                                data-height="['none','none','none','none']"
                                data-whitespace="['normal','normal','normal','normal']"
                                ...
                                font-weight: 600;
                                color:#fff;
                                border-width:0px; font-family: 'Teko', sans-serif">Transform your outdoor Living Space</div>
                            
                                <!-- LAYER NR. 5 [ for see all service botton ] -->
                                <div class="tp-caption tp-resizeme"     
                                id="slide-901-layer-5"                      
                                data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']" 
                                data-y="['middle','middle','middle','middle']" data-voffset="['250','100','100','20']"  
                            ...
                            data-description="">
                                ...
                                white-space: normal; 
                                font-weight: 500;
                                font-family: 'Teko', sans-serif;">We Have More Than 24 Years Experince</div>
                                ...
                                font-weight: 600;
                                color:#fff;
                                border-width:0px; font-family: 'Teko', sans-serif">Excellence in landscaping services</div>
                            ...
                            data-description="">
                                ...
                                white-space: normal; 
                                font-weight: 500;
                                font-family: 'Teko', sans-serif;">Design Your Dream Outdoor Unit With Lawwnella</div>
                                ...
                                font-weight: 600;
                                color:#fff;
                                border-width:0px; font-family: 'Teko', sans-serif">Affordable & Quality Lawn Care</div>
                       ...
                       <div class="section-content">
                            ...
                            <div class="item">
                                <div class="line-filter-outer ">
                                    ...
                                    <div class="line-filter  bg-white p-a30">
                                        <div class="filter-content">
                                            <h3 class="m-t0 m-b20 text-uppercase">Lawn Renovation</h3>
                                            <a href="project-detail.html" class="site-button-link">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="line-filter-outer">
                                    <div class="line-filter-media">
                                        ...
                                        <div class="hover-effect-1">
                                            <div class="hover-effect-content text-white">
                                                ...
                                                <p>Lorem ipsum dolor sit amet,tetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                                <a href="images/gallery/portrait-2/pic3.jpg" class="mfp-link"><i class="fa fa-search-plus"></i></a>
                                            </div>
                                        </div>                                              
                                    </div>
                                    ...
                                    <div class="line-filter  bg-white p-a30">
                                        <div class="filter-content">
                                            <h3 class="m-t0 m-b20 text-uppercase">Lawn Maintenance</h3>
                                            <a href="project-detail.html" class="site-button-link">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="line-filter-outer">
                                    <div class="line-filter-media">                                 
                                        ...
                                        <div class="hover-effect-1">
                                            <div class="hover-effect-content text-white">
                                                ...
                                                <p>Lorem ipsum dolor sit amet,tetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                                <a href="images/gallery/portrait-2/pic4.jpg" class="mfp-link"><i class="fa fa-search-plus"></i></a>
                                            </div>
                                        </div>                                          
                                    </div>
                                    ...
                                    <div class="line-filter  bg-white p-a30">
                                        <div class="filter-content">
                                            <h3 class="m-t0 m-b20 text-uppercase">Landscape Lighting</h3>
                                            <a href="project-detail.html" class="site-button-link">Read More</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item fadingcol interior-col">
                                <div class="line-filter-outer">
                                    <div class="line-filter-media">                                
                                        <img src="images/gallery/portrait-3/pic5.jpg" alt="">
                                        <div class="hover-effect-1">
                                            <div class="hover-effect-content text-white">
                                                <h3 class="m-tb0 h-category">Clean-ups</h3>
                                                <p>Lorem ipsum dolor sit amet,tetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                                <a href="images/gallery/portrait-2/pic5.jpg" class="mfp-link"><i class="fa fa-search-plus"></i></a>
                                            </div>
                                        </div>                                           
                                    </div>
                                    ...
                                    <div class="line-filter  bg-white p-a30">
                                        <div class="filter-content">
                                            <h3 class="m-t0 m-b20 text-uppercase">Seasonal Clean-ups</h3>
                                            <a href="project-detail.html" class="site-button-link">Read More</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item fadingcol restaurant-col">
                                <div class="line-filter-outer">
                                    <div class="line-filter-media">                                
                                        <img src="images/gallery/portrait-3/pic6.jpg" alt="">
                                        <div class="hover-effect-1">
                                            <div class="hover-effect-content text-white">
                                                <h3 class="m-tb0 h-category">Flowerscaping</h3>
                                                <p>Lorem ipsum dolor sit amet,tetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                                <a href="images/gallery/portrait-2/pic6.jpg" class="mfp-link"><i class="fa fa-search-plus"></i></a>
                                            </div>
                                        </div>                                            
                                    </div>
                                    ...
                                    <div class="line-filter  bg-white p-a30">
                                        <div class="filter-content">
                                            <h3 class="m-t0 m-b20 text-uppercase">Flowerscaping</h3>
                                            <a href="project-detail.html" class="site-button-link">Read More</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- VIDEO SECTION START -->
            <div class="section-full video-counter-section p-t80 bg-gray">
                        ...
                        <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 m-b50">
                                        ...
                                        <div class="wt-box service-box-2 bg-white">
                                            ...
                                            <div class="service-box-2-media m-b20">
                                                <img src="images/project_3/pic1.jpg" alt="">
                                            </div>
                                            
                                            <div class="service-box-title title-style-2 site-text-secondry">
                                                <span  class="s-title-one">Modren Garden</span>
                                                <span  class="s-title-two"></span>     
                                            </div>
                                            <div class="service-box2-content">
                                                <p>Progressively maintain extensive infomediaries via extensible nich.</p>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 m-b50">
                                        ...
                                        <div class="wt-box service-box-2 bg-white">
                                            ...
                                            <div class="service-box-2-media m-b20">
                                                <img src="images/project_3/pic2.jpg" alt="">
                                            </div>                                            
                                            
                                            <div class="service-box-title title-style-2 site-text-secondry">
                                                <span class="s-title-one">Wooden Decks</span>
                                            </div>
                                            <div class="service-box2-content">
                                                <p>Progressively maintain extensive infomediaries via extensible nich.</p>
                                                <a href="s-mechanical.html" class="site-button-link">Read More</a>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 m-b50">
                                        ...
                                        <div class="wt-box service-box-2 bg-white">
                                            ...
                                            <div class="service-box-2-media m-b20">
                                                <img src="images/project_3/pic3.jpg" alt="">
                                            </div>                                        
                                            
                                            <div class="service-box-title title-style-2 site-text-secondry">
                                                <span  class="s-title-one">Leaf Cutting</span>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 m-b50">
                                        ...
                                        <div class="wt-box service-box-2 bg-white">
                                            ...
                                            <div class="service-box-2-media m-b20">
                                                <img src="images/project_3/pic4.jpg" alt="">
                                            </div>                                       
                                            
                                            <div class="service-box-title title-style-2 site-text-secondry">
                                                <span  class="s-title-one">Lawn Mower</span>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 m-b50">
                                        ...
                                        <div class="wt-box service-box-2 bg-white">
                                            ...
                                            <div class="service-box-2-media m-b20">
                                                <img src="images/project_3/pic5.jpg" alt="">
                                            </div>                                        
                                            
                                            <div class="service-box-title title-style-2 site-text-secondry">
                                                <span class="s-title-one">Parking Cleaning</span>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 m-b50">
                                        ...
                                        <div class="wt-box service-box-2 bg-white">
                                            ...
                                            <div class="service-box-2-media m-b20">
                                                <img src="images/project_3/pic6.jpg" alt="">
                                            </div>                                        
                                            
                                            <div class="service-box-title title-style-2 site-text-secondry">
                                                <span  class="s-title-one">Design Planting</span>
                                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 col-sm-12 m-b30">
                                <div class="wt-team-1">
                                    ...
                                    <div class="wt-media">
                                        <img src="images/team-5/pic1.jpg" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 m-b30">
                                <div class="wt-team-1">
                                    ...
                                    <div class="wt-media">
                                        <img src="images/team-5/pic2.jpg" alt="">
                                        <div class="team-social-center">
                                            <ul class="team-social-bar">
                                                <li><a href="javascript:void(0);"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="javascript:void(0);"><i class="fa fa-twitter"></i></a></li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 m-b30">
                                <div class="wt-team-1">
                                    ...
                                    <div class="wt-media">
                                        <img src="images/team-5/pic3.jpg" alt="">
                                        <div class="team-social-center">
                                            <ul class="team-social-bar">
                                                <li><a href="javascript:void(0);"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="javascript:void(0);"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="section-full self-intro-section-outer overlay-wraper bg-cover" style="background-image:url(<?php echo base_url();?>assets/frontend/images/background/bg-14.jpg)">                                 
                ...
                <div class="container">
                    <div class="self-intro-pic-block2">
                        <div class="wt-media"><img src="images/self-pic-2.png" alt=""></div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="wt-separator-two-part">
                        <div class="row wt-separator-two-part-row">
                            ...
                            <div class="col-lg-4 col-md-5 wt-separator-two-part-right text-right">
                                <a href="blog-grid.html" class="site-button site-btn-effect">More Detail</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-content">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-6 col-md-6 col-sm-12 m-b30">
                                ...
                                <div class="blog-post date-style-2">
                                    <div class="wt-post-media wt-img-effect zoom-slow">
                                        <a href="javascript:;"><img src="images/blog/default-5/thum1.jpg" alt=""></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 m-b30">
                                ...
                                <div class="blog-post date-style-2">
                                    <div class="wt-post-media wt-img-effect zoom-slow">
                                        <a href="javascript:;"><img src="images/blog/default-5/thum2.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-post-info bg-white p-t30">
                                        <div class="wt-post-meta ">
                                            <ul>
                                                <li class="post-category"><span>Technology</span> </li>
                                                <li class="post-date">February 28, 2020</li>
                                                <li class="post-comment">24 Comment</li>                                      
                                            </ul>
                                        </div>                                  
                                        <div class="wt-post-title ">
                                            <h3 class="post-title">Present you with examples of 3 posts from authority websites click</h3>
                                        </div>
                                        <div class="wt-post-readmore ">
                                            <a href="blog-post-right-sidebar.html" class="site-button-link black">Read More</a>
                                        </div>                                        
